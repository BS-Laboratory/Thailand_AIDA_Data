...
Generating columns based on the level obtained using CheckBox package
...
Generate columns for taking_hormones to match REDCap template using CheckBox package

Changing the variable name for CheckBox functions.
